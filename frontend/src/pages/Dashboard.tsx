...
function BreakdownBars({ title, data }: { title: string; data: Record<string, number> | undefined }) {
        ...
        {stats && (
          <>
            ...
            <div className="dashboard-grid">
              <BreakdownBars title="By Status" data={stats.by_status} />
              <BreakdownBars title="By Priority" data={stats.by_priority} />
              <BreakdownBars title="By Category" data={stats.by_category} />
              <BreakdownBars title="By Team" data={stats.by_team} />
            </div>
          </>
        )}
      </StateGate>
      ...
      <div className="dashboard-grid">
        <div className="card">
          ...
          <StateGate
            ...
            error={null}
            isEmpty={!!recentIncidents && (recentIncidents.items?.length === 0 || !recentIncidents.items)}
        ...
        <div className="card">
          ...
          <StateGate
            ...
            error={null}
            isEmpty={!!resolvedIncidents && (resolvedIncidents.items?.length === 0 || !resolvedIncidents.items)}
